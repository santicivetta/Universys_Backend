...
if($eCon==null){
  ...
  //PRUEBA 1
  $datos= doABMMaterias(["apiVer" => apiVersionActual, "idSesion" => "1", "operacion" => "modificacion", "idMateria"=>"2","materia" => "Analisis Matematico"]);
  ...
  //PRUEBA 2
  $datos= doABMMaterias(["apiVer" => apiVersionActual, "idSesion" => "1", "operacion" => "modificacion", "idMateria"=>"1","materia" => "Analisis Matematico"]);
  $datosParseados= json_decode($datos, true);
  ...
  //PRUEBA 3
  $datos= doABMMaterias(["apiVer" => apiVersionActual, "idSesion" => "1", "operacion" => "modificacion", "materia" => "Algebra"]);
  $datosParseados= json_decode($datos, true);
