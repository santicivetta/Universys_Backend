...
if($eCon==null){
  ...
  //PRUEBA 1
  $datos= doABMUsuarios(["apiVer" => apiVersionActual, "idSesion" => "1", "operacion" => "baja", "nombre" => "Gaston", "apellido" => "Bodeman","documento" => "37213234", "fnac" => "1994-09-20","genero" => "Masculino","domicilio" => "Blanco Encalada 4892","telefono" => "45228786","mail" => "gaston.bodeman@comunidad.ub.edu.ar","contraseña" => "contraseñagaston"]);
